...
allprojects {
    ...
    version = (System.getenv("APPREN_VERSION") ?: "v0.0").substring(1)
        ...
        configure<UnifiedPublishingExtension> {
            project {
                ...
                relations {
                    ...
                    optional {
                        curseforge.set("macaws-bridges")
                        curseforge.set("macaws-windows")
                        curseforge.set("macaws-paths-and-pavings")
                        curseforge.set("macaws-fences-and-walls")
                        curseforge.set("macaws-roofs")
                    }
                }
